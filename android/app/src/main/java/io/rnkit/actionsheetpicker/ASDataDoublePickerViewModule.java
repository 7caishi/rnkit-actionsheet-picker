...
import io.rnkit.actionsheetpicker.view.DataDoublePickerView;

/**
 * Created by SimMan on 2016/11/30.
 */

public class ASDataDoublePickerViewModule extends ReactContextBaseJavaModule implements Application.ActivityLifecycleCallbacks {

    private static final String REACT_CLASS = "RNKitASDataDoublePicker";
    ...
    public ASDataDoublePickerViewModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void showWithArgs(@Nullable final ReadableMap options, @Nullable final Callback callback) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                DataDoublePickerView pvOptions = new DataDoublePickerView(pickerProperty);
                setPickerDataSource(dataSource, pvOptions);
                pvOptions.setSelectOptions(option1, option2, option3);

                pvOptions.setOnTimeCancelListener(new DataDoublePickerView.OnTimeCancelListener() {
                    @Override
